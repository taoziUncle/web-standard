 ...
 * @param cwd
 * @param pkg
 * @returns encode-fe-eslint-config/index
 * @returns encode-fe-eslint-config/react
 * @returns encode-fe-eslint-config/typescript/index
 * @returns encode-fe-eslint-config/typescript/react
 */
